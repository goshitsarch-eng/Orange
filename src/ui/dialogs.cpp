...
void Dialogs::EditTag(GtkWindow *parent, Application *app, const SongList &songs, const std::vector<int> &playlist_rows) {
  EditTagDialog::Show(parent, app, songs, playlist_rows);
}
